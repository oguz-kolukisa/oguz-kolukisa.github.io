...
printf "\rInstalling Anaconda... Done\n"
...
rm -f anaconda.sh
printf "Removed Anaconda installer.\n"
printf "Anaconda installed. Please restart your terminal or run 'source ~/.bashrc' to activate conda.\n"
